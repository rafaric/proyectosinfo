...
function Base(props) {
    ...
    return(
        ...
        <section className='tecnologias--section'>
            ...
            <div className="tecnologia" data-tooltip-id="html" data-tooltip-content="HTML5"><img src={html5} alt="" className="tecno-img" /></div>
            <div className="tecnologia" data-tooltip-id="ccs3" data-tooltip-content="CCS3"><img src={ccs3} alt="" className="tecno-img" /></div>
            <div className="tecnologia" data-tooltip-id="Bootstrap" data-tooltip-content="Bootstrap"><img src={boot} alt="" className="tecno-img" /></div>
            <div className="tecnologia" data-tooltip-id="Javascript" data-tooltip-content="Javascript"><img src={js} alt="" className="tecno-img" /></div>
            <div className="tecnologia" data-tooltip-id="react" data-tooltip-content="React"><img src={rea} alt="" className="tecno-img" /></div>
            <div className="tecnologia" data-tooltip-id="next" data-tooltip-content="NextJs"><img src={next} alt="" className="tecno-img" /></div>
            <div className="tecnologia" data-tooltip-id="sql" data-tooltip-content="MySql"><img src={sql} alt="" className="tecno-img" /></div>
            <div className="tecnologia" data-tooltip-id="post" data-tooltip-content="Postgress"><img src={post} alt="" className="tecno-img" /></div>
            <div className="tecnologia" data-tooltip-id="python" data-tooltip-content="Python"><img src={python} alt="" className="tecno-img" /></div>
            <div className="tecnologia" data-tooltip-id="django" data-tooltip-content="Django"><img src={django} alt="" className="tecno-img" /></div>
            </div>
            <Tooltip id="html" />
            <Tooltip id="ccs3"/>
        ...
        <section className='about'>
            <div className='about--container'>
                ...
                <p className='about-contenido'>Tengo 42 años, soy de Resistencia, Chaco, Argentina. Mi pasión por la programación empezó hace mucho, con el legendario
                    GwBasic! Actualmente, soy un autodidacta a tiempo completo. Busco tutoriales, tips, desafíos, cursos y todo 
                    aquello que me permita seguir completando mi conocimiento sobre este apasionante mundo de la programación, 
                    en especial el FrontEnd. Quiero emprender nuevos desafíos, compartir mis conocimientos y hacer que cualquier proyecto
