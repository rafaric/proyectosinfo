...
function Base(props) {
  ...
  async function loadingInfo(ciudad = "Resistencia") {
    const respuesta = await fetch(`http://api.weatherapi.com/v1/current.json?key=a8b731c8e9eb42edac505612232302&q=${ciudad}&aqi=no`);
  ...
  return (
    <>
      ...
      <main className="header">
        ...
        <a href="#" className="bn39"><span className="bn39span">Contacto</span>
        </a>
      </main>
